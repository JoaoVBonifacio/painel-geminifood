// Adicione a propriedade onThemeToggleClick
interface HeaderProps {
  cartItemCount: number;
  onCartClick: () => void;
  onScheduleClick: () => void;
  onThemeToggleClick: () => void; // Adicionado
}

// Adicione a nova propriedade e o botão
export const Header = ({ cartItemCount, onCartClick, onScheduleClick, onThemeToggleClick }: HeaderProps) => (
  <header className="bg-white shadow-md sticky top-0 z-10 dark:bg-gray-800 dark:border-b dark:border-gray-700">
    <div className="container mx-auto max-w-4xl p-4 flex justify-between items-center">
      ...
      <div className="flex items-center space-x-2">
        ...
        <button onClick={onThemeToggleClick} id="theme-toggle-btn" className="p-2 rounded-full text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">
            {/* Ícone de Sol */}
            <svg id="theme-icon-light" className="w-6 h-6" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="4"/><path d="M12 2v2"/><path d="M12 20v2"/><path d="m4.93 4.93 1.41 1.41"/><path d="m17.66 17.66 1.41 1.41"/><path d="M2 12h2"/><path d="M20 12h2"/><path d="m6.34 17.66-1.41 1.41"/><path d="m19.07 4.93-1.41 1.41"/></svg>
            {/* Ícone de Lua */}
            <svg id="theme-icon-dark" className="w-6 h-6 hidden" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z"/></svg>
        </button>
        {/* Botão do Carrinho */}
