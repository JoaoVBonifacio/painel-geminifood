            ...
            {cart.length > 0 && (
              <div className="p-5 border-t bg-gray-50 rounded-b-2xl flex-shrink-0 dark:bg-gray-900/50 dark:border-gray-700">
                ...
                <button
                  ...
                  className="w-full bg-green-500 text-white font-bold py-3 px-5 rounded-lg disabled:bg-gray-300 disabled:cursor-not-allowed hover:bg-green-600 transition-all duration-200 text-center"
                >
                  Finalizar Pedido
                </button>
              </div>
