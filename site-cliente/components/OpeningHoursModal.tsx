...
export const OpeningHoursModal = ({ isOpen, onClose }: OpeningHoursModalProps) => {
  ...
  return (
    ...
    >
      <div
        className={`bg-white rounded-2xl shadow-xl w-full max-w-sm flex flex-col transform transition-all duration-300 ease-in-out ${isOpen ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}
      ...
      >
        ...
        <div className="p-6 space-y-3">
          <div className="flex justify-between">
            <span className="font-semibold text-gray-700">Terça a Sexta</span>
            <span className="text-gray-600">15:00 às 23:00</span>
          </div>
          <div className="flex justify-between">
            <span className="font-semibold text-gray-700">Sábado e Domingo</span>
            <span className="text-gray-600">10:00 às 23:00</span>
          </div>
          <div className="flex justify-between">
